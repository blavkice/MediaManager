...
void MenuBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->mediaImported(); break;
        case 1: _t->onImportActionTriggered(); break;
        case 2: _t->onExportActionTriggered(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (MenuBar::*)()>(_a, &MenuBar::mediaImported, 0))
            return;
    }
}
